...
<template>
    <section class="container flex flex-col gap-3 justify-center lg:flex-row mx-auto my-8">
        <div class="border-2 border-yellow-400 flex flex-row items-center justify-center mx-5 px-5 py-4">
            <div> <svg fill="none" stroke="currentColor" stroke-width="1.5" class="h-6 lg:mr-2 text-violet-900 w-6"
                viewBox="0 0 24 24">
            ...
            <p class="lg:text-left lg:text-sm text-center text-light text-xs"> Orders from $200 </p>
            </div>
        </div>
        <div class="border-2 border-yellow-400 flex flex-row items-center justify-center mx-5 px-5 py-4">
            <div> <svg fill="none" stroke="currentColor" stroke-width="1.5" class="h-6 lg:mr-2 text-violet-900 w-6"
