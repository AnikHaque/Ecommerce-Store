...
onMounted(async () => {
    ...
    activeImageURL.value = product.value.thumbnail;
});
            ...
            <div class="lg:col-span-3 lg:row-end-1">
                ...
                <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                    <div class="flex flex-row items-start lg:flex-col">
                        <button @click="activeImageURL = image" v-for="(image,index) in product.images" :key="index" type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
            ...
            <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                ...
                <div class="mt-3 flex select-none flex-wrap items-center gap-1">
                    <label class="">
                        ...
                        <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">{{ product.category }}</p>
                    </label>
                </div>
                ...
                <button @click="cartStore.add(productStore.product)" type="button" class="inline-flex items-center justify-center rounded-md border-2 border-transparent bg-gray-900 bg-none px-12 py-3 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-gray-800">
